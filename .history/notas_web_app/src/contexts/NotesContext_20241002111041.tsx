      ...
      return {
        ...
        collections: state.collections.map(collection => {
          if (collection.id === action.payload.collectionId) {
            const newNote = {
              ...action.payload.note,
              id: state.nextNoteId.toString(), // Asignar ID secuencial
            };
            return {
              ...collection,
              notes: [...collection.notes, newNote], // Agregar la nueva nota
            };
          }
          return collection;
        }),
        nextNoteId: state.nextNoteId + 1, // Incrementar el ID para la próxima nota
      };
    case 'DELETE_NOTE':
      return {
        ...state,
